...
public class Barrier_Blue : MonoBehaviour
{
    public AddScoreBlue player;//定义PlayerControl类
    public int score;//定义积分变量
    public Text ScoreUI;//定义要修改的Text
    private bool flag = false;
    public static bool blue_win = false;
    ...
    private int Score//定义积分属性，使用属性来进行控制，使每次积分被改变时就调用一次文本显示的修改
    {
        ...
        set
        {
            ...
            ScoreData.Instance.Score_blue += score;
            showWin();
            flag = true;
        }
    }
    ...
    private void showWin()
    {
        ...
        text.DOText("The blue team scores!!!", 2); //5秒时间将这段文字逐字显示
        text.DOColor(Color.blue, 4); //颜色逐渐变绿
        Debug.Log("22");     
